...
const GardenPath = () => {
  ...
  return (
    <Layout>
      ...
      <Expander text="Remove old path" className="green expander">
      ...
      <Expander text="Lay foundation" className="blue expander">
      ...
      <Expander text="Laying the tiles" className="yellow expander">
        ...
        <Card>
          <span className="ordinal">1 of 10</span>
          <h3>Tiles</h3>
        ...
        <Card>
          <span className="ordinal">2 of 10</span>
          <h3>Tiles</h3>
        ...
        <Card>
          <span className="ordinal">3 of 10</span>
          <h3>Tiles</h3>
        ...
        <Card>
          <span className="ordinal">4 of 10</span>
          <h3>Tiles</h3>
        ...
        <Card>
          <span className="ordinal">5 of 10</span>
          <h3>Laying them</h3>
        ...
        <Card>
          <span className="ordinal">6 of 10</span>
          <h3>Laying them</h3>
        ...
        <Card>
          <span className="ordinal">7 of 10</span>
          <h3>Laying them</h3>
        ...
        <Card>
          <span className="ordinal">8 of 10</span>
          <h3>Tidy-up</h3>
        ...
        <Card>
          <span className="ordinal">9 of 10</span>
          <h3>Tidy-up</h3>
        ...
        <Card>
          <span className="ordinal">10 of 10</span>
          <h3>Tidy-up</h3>
          <p>Has this activity been completed?</p>
          <MultiChoice choices={["Yes", "No", "Not sure"]} />
          <button onClick={scrollNext}>Submit</button>
      ...
      <Expander text="Using the path" className="purple expander">
